...
Tu trouveras ici les étapes ainsi que le code de la demo de la recette [ici](https://github.com/departement-info-cem/3M5-IntroMobile/tree/main/code/ComposeMultilingue).
