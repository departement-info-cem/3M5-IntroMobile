...
## settings.gradle.kts
        ...
        <Row>
            ...
            [![settings.gradle.kts](_jitpack/setting.gradle.kts.png)](_jitpack/setting.gradle.kts.png)
...
## jitpack.com
        ...
        La librairie que vous souhaitez obtenir possède plusieurs versions différentes.

        Vous devez choisir la version qui vous intéresse (souvent la plus récente).

        [![jitpack](_jitpack/jitpack.png)](_jitpack/jitpack.png)

        L'implémentation choisie sera utilisée à la prochaine étape.
...
## build.gradle.kts">
        ...
        dependencies {
            // Autres imports...
            // Attention! Ce n'est pas la même libraire qui est requise pour le TP2.
